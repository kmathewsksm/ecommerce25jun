  ...
  return (
    <Container className="product-description">
      <Row>
        <Col
          md={4}
          className="d-flex flex-column justify-content-center border p-3 pic-section"
        >
          <div
          ...
          >
            <FaHeart
              color={wishlistedIds?.includes(product.id) ? "red" : "#cbc2c2"}
              onClick={() => {
        ...
        <Col md={8}>
          ...
          <div className="rating mb-3 d-flex align-items-center">
            ...
            <span
              style={{ fontWeight: "400", fontSize: "16px", marginLeft: "4px" }}
            >
          ...
          <div className="d-flex justify-content-between gap-2 mt-4">
            <h4>
              $ {product.price}{" "}
              <span class="price-info">inclusive of all taxes</span>
            </h4>
            <Button
